...
export default function GuidePage() {
  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      {/* Hero typography */}
      <header className="flex flex-col items-center justify-center text-center px-8 pt-12 pb-16 shrink-0">
        ...
        {guideCities.map(({ city, guide }, i) => (
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 p-5">
              <p
                className="text-[9px] tracking-[0.45em] uppercase mb-1.5 transition-colors duration-300"
                style={{ color: city.color }}
              >
                Guide
              </p>
              ...
              <p className="text-white/0 group-hover:text-white/40 text-[10px] mt-1.5 tracking-widest uppercase transition-colors duration-300">
                Explore →
              </p>
            </div>
